...
import { ArrowDown, BarChart2, ChevronDown, ChevronUp, DollarSign, PieChartIcon, PiggyBank, Plus, ShoppingCart, TrendingDown, TrendingUp , Wallet, TrendingUp as ProfitIcon } from 'lucide-react';
...
function Dashboard() {
  ...
  //function to check if a date is wihtin range
  ...
  //update the gauge when time frame chanegs
  useEffect(() => {
    const maxValues = {
  ...
  //build server-provided recnet list
  ...
  //add,edit or delete:-(making entry to DB)
  const handleAddTransaction = async() => {
    ...
    try {
      ...
      await refreshTransactions(); //refresh the page
     ...
     <div className={dashboardStyles.container}>
      ...
      <div className={dashboardStyles.headerContainer}>
         <div className={dashboardStyles.headerContent}>
            <div>
              ...
              <p className={dashboardStyles.headerSubtitle}>Track your income and expense</p>
            </div>
            {/*check this out*/}
      ...
      <div className={dashboardStyles.summaryGrid}>
            <FinancialCard icon={
              ...
              value={`$${Math.round(displayExpenses)}`}
              additionalContent={
      ...
      {/*Add Transaction modal => props are from here this is parent that we are defining down */}
