...
function Layout({onLogout, user}) { //defined in parent APP
  ...
  useEffect(() => { //call this every time page reload
    fetchTransactions();
  }, []);
  ...
  return (
    <div className={styles.layout.root}>
          ...
          <Sidebar user={user} onLogout={onLogout} isClose={sidebarClose} setClose={setSidebarClose}
          />
          {/* dashboard */}
          <div className={styles.layout.mainContainer(sidebarClose)}>
                  ...
                  <div className={styles.statCards.card}>
                      <div className={styles.statCards.cardHeader}>
                         <div>
                            ...
                            <p className={styles.statCards.cardValue}>${stats.allTimeSavings.toLocaleString("en-US",{
                  ...
                  <div className={styles.statCards.card}>
                      <div className={styles.statCards.cardHeader}>
                         <div>
                            ...
                            <p className={styles.statCards.cardValue}>${stats.last30DaysIncome.toLocaleString("en-US",{
                              maximumFractionDigits: 2
                            })}
                            </p>
                         </div>
                  ...
                  <div className={styles.statCards.card}>
                      <div className={styles.statCards.cardHeader}>
                         <div>
                            ...
                            <p className={styles.statCards.cardValue}>${stats.last30DaysExpenses.toLocaleString("en-US",{
                              maximumFractionDigits: 2
                            })}
                            </p>
                         </div>
                  ...
                  <div className={styles.statCards.card}>
                      <div className={styles.statCards.cardHeader}>
                         ...
                         <div className={styles.statCards.iconContainer("blue")}>
                              <PiggyBankIcon className={styles.statCards.icon("blue")}/>
                         </div>
                      </div>
                      <p className={styles.statCards.cardFooter}>
